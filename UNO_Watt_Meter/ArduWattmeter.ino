...
void loop() {
  ...
  Ah = Ah + Current * 0.00000431987;// коэфициент для ампер часов
  Wh = Wh + Watt * 0.00000431987;// коэфициент для ватт часов
...
int analogReadOversampled(byte analogChannel)  {
  ...
  return aSum >> 6;   // агалог деления на 64
}
